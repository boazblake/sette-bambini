...
var InvoiceCell = function InvoiceCell() {
  return {
    view: function view(_ref3) {
      ...
      return screenSize == "phone" ? m("tr", [m("td", children[0].key), children]) : children;
    }
  };
};
...
var Invoice = function Invoice(_ref4) {
  ...
  return {
    view: function view(_ref5) {
      ...
      return [m("tr.invoice", m(InvoiceCell, {
        mdl: mdl
      }, m("td", {
        key: "Date"
      ...
      }, "".concat(invoice.shippingDestination.name.full_name, " ").concat(invoice.shippingDestination.address.address_line_1, " ").concat(invoice.shippingDestination.address.admin_area_2, " ").concat(invoice.shippingDestination.address.admin_area_1, " ").concat(invoice.shippingDestination.address.postal_code))), m(InvoiceCell, {
        mdl: mdl
      }, m("td", {
        key: "payment status"
...
var Orders = function Orders() {
  return {
    ...
    view: function view(_ref6) {
      ...
      }, [m("h3", "Orders"), state.invoices.any() ? m("table", {
        style: {
          width: "100%"
        }
      }, [mdl.settings.screenSize != "phone" && m("thead", m("tr", [m("th", "Date"), m("th", "order Id"), m("th", "shipping Destination"), m("th", "payment status"), m("th", "shipping status"), m("th")])), m("tbody", state.invoices.map(function (invoice) {
        return m(Invoice, {
          mdl: mdl,
          invoice: invoice
        });
...
var Account = function Account() {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".frow-container", m("h2", "Welcome ", mdl.user.name), m(_orders.Orders, {
        mdl: mdl
      }));
    }
  };
...
;require.register("Pages/Account/users.js", function(exports, require, module) {
"use strict";
...
;require.register("Pages/Dashboard/address.js", function(exports, require, module) {
"use strict";
...
var Dashboard = function Dashboard() {
  return {
    view: function view(_ref) {
      ...
      }, mdl.state.showPriceModal() ? "Hide Prices" : "Show Prices"), m("Button", {
        onclick: function onclick(e) {
          return mdl.toggleUserModal(mdl);
        }
      }, mdl.state.showUserModal() ? "Hide Users" : "Show Users"), mdl.state.showPriceModal() && m(_prices.PriceAdjustment, {
        mdl: mdl
      }), mdl.state.showUserModal() && m(_users.Users, {
        mdl: mdl
      }), m(_orders.Orders, {
        mdl: mdl
      }));
...
var Users = function Users() {
  ...
  return {
    ...
    view: function view(_ref2) {
      var mdl = _ref2.attrs.mdl;
      return m("section", [m("h3", "Users"), m("ul", state.users.map(function (user) {
        return m(".frow input", m("label", user.name), m("input", {
          type: "checkbox",
