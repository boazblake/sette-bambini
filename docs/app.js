  ...
  return {
    ...
    view: function view(_ref) {
      ...
      return m(".frow-container frow-center", [m(".mb-30", {
        ...
        mdl: mdl,
        product: "Wraps"
      })), m("ul", [m("li.pb-10", '100% Pure Wool Carriage style Blanket 21" x 18"'), m("li.pb-10", "Machine wash and tumble dry."), m("li.pb-10", "Proudly made in Houston Texas USA")])]), m(".mb-30", {
        id: "christening"
