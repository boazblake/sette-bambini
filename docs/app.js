...
var NavLink = function NavLink() {
  return {
    view: function view(_ref) {
      ...
      return m(m.route.Link, _objectSpread({}, handlers(["onclick", "onmouseover", "onmouseout"], function (e) {
...
var NavBar = function NavBar() {
  ...
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return [mdl.settings.screenSize !== "phone" && m(".navbar", m("nav.frow row-around", SidebarRoutes(mdl).map(function (r) {
