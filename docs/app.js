...
var InvoiceCell = function InvoiceCell() {
  return {
    view: function view(_ref3) {
      ...
      }, m("label", children[0].key)), children]) : children;
    }
  };
};
...
var Orders = function Orders() {
  return {
    ...
    view: function view(_ref6) {
      ...
      }, state.invoices.any() ? m("table.dash-table", mdl.settings.screenSize != "phone" && m("thead", m("tr.mb-5", [m("th", "Date"), m("th", "Order Id"), m("th", "Shipping Destination"), m("th", "Payment Status"), m("th", "Shipping Status"), m("th")])), m("tbody", state.invoices.map(function (invoice) {
        return m(Invoice, {
          mdl: mdl,
          invoice: invoice
        });
...
var Account = function Account() {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".frow-container", m("h2", "Orders"), m(_orders.Orders, {
        mdl: mdl
      }));
    }
  };
...
var Dashboard = function Dashboard() {
  ...
  return {
    view: function view(_ref) {
      ...
      }, m("section.frow row-around", navi.map(function (nav) {
        return m("button", {
