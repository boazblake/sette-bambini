...
var CartModal = function CartModal(_ref6) {
  ...
  return {
    ...
    view: function view(_ref8) {
      ...
      }), getTotal(mdl, products(mdl.cart)) ? m(".frow centered-column", m(_navLink.NavLink, {
        mdl: mdl,
        href: "/checkout",
        classList: "".concat((0, _helpers.isActiveRoute)("/checkout"), " para button m-0"),
        link: ["Proceed to Checkout", m("h1.bold text-center", "Total of ".concat(getQuantity(products(mdl.cart)), " for ").concat(mdl.state.currency(), ": ").concat(getTotal(mdl, products(mdl.cart))))]
...
var Gender = function Gender() {
  return {
    view: function view(_ref) {
      ...
      return quantity ? m(".frow row-around", [m("img", {
        src: "https://via.placeholder.com/80"
      }), m("h4", "".concat(sex, " : ").concat(quantity)), m(_Selector["default"], {
        mdl: mdl,
        product: product
      })]) : null;
    }
...
var Product = function Product(_ref2) {
  ...
  return {
    view: function view(_ref3) {
      ...
      return amount ? m(".frow  mt-10", [m("h3", "".concat(amount, " ").concat(title, " for ").concat(mdl.state.currency(), " ").concat(price)), m(".frow cart-item column-start", genders.map(function (gender) {
        return m(Gender, {
          mdl: mdl,
          gender: gender,
          product: title
...
var Cart = function Cart(_ref4) {
  ...
  return {
    ...
    view: function view(_ref6) {
      var mdl = _ref6.attrs.mdl;
      return m(".frow-container frow-center", [(0, _helpers.toProducts)(mdl.cart).map(function (p) {
        return m(Product, {
          mdl: mdl,
          p: p
        });
