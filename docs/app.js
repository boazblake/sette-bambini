...
var Indicators = {
  view: function view(_ref) {
    ...
    return (0, _mithril["default"])(".frow row-between", children.map(function (src, idx) {
      return (0, _mithril["default"])(".clickable.carousel-indicator", {
      ...
      }, (0, _mithril["default"])("img.carousel-slide", {
...
var Carousel = function Carousel() {
  ...
  return {
    view: function view(_ref2) {
      ...
      return (0, _mithril["default"])(".carousel-container", {
      ...
      }, (0, _mithril["default"])(".carousel-wrapper.width-100", {
        id: ident,
        ...
        return (0, _mithril["default"])("img.carousel-slide", {
          src: src,
          id: "".concat(ident, "-").concat(idx)
        });
      })), (0, _mithril["default"])(Indicators, {
        ident: ident,
        state: state
      }, children));
    }
