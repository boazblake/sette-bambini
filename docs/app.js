  ...
  return {
    ...
    view: function view(_ref6) {
      ...
      return m(".frow-container frow-center", [(0, _helpers.getTotal)(mdl, (0, _helpers.toProducts)(mdl.cart)) ? m(_navLink.NavLink, {
        ...
        link: [m("h1.bold text-center.mt-20.mb-20", "Total of ".concat((0, _helpers.getQuantity)((0, _helpers.toProducts)(mdl.cart)), " for ").concat(mdl.state.currency()).concat((0, _helpers.getTotal)(mdl, (0, _helpers.toProducts)(mdl.cart))))]
      }), m(".", {
        oncreate: function oncreate(_ref7) {
          var dom = _ref7.dom;
          return paypal.Buttons().render(dom);
        }
      }))] : m("h1.bold", "Your Cart is Empty")]);
    }
  };
