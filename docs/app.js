...
var Brick = function Brick() {
  ...
  return {
    view: function view(_ref) {
      ...
      return m(".brick", {
        "class": classList
      }, m(".content", [m("h3.title", data.title), m(".description", [m("img", {
        onload: function onload(x) {
          console.log("brick image onload", x, _dom); // m.redraw()
        },
...
;require.register("Components/nav-menu.js", function(exports, require, module) {
"use strict";
...
var NavMenu = function NavMenu() {
  var state = {
    status: function status(mdl) {
      return mdl.state.showNavMenu() ? "navMenuShow" : "navMenuHide";
    }
  };
  ...
  return {
    view: function view(_ref2) {
      ...
      return m(".".concat(state.status(mdl)), {
        oncreate: _animations.SlideInLeft,
        onbeforeremove: _animations.SlideOutRight
      }, m(".navMenuOverlay", {
        onclick: function onclick() {
          return mdl.state.showNavMenu(false);
        }
      }, m("ul.nav", {
        id: ""
      }, [mdl.state.user ? m("a", {
        onclick: function onclick() {// mdl.state.showNavMenu(false)
          // mdl.toggleAuthModal(mdl)
        }
      }, m(_index.LockLine)) : m(".frow", [m(NavItem, {
        mdl: mdl,
        href: "/login",
        link: "Login",
        classList: "".concat(isActiveRoute("/login"), " button")
      }), m(NavItem, {
        mdl: mdl,
        href: "/register",
        link: "Register",
        classList: "".concat(isActiveRoute("/register"), " button")
...
var _navLink = _interopRequireDefault(require("./nav-link.js"));
...
var NavBar = function NavBar() {
  ...
  return {
    view: function view(_ref) {
      ...
      return m(".navbar", m("nav.frow row-around text-center", {
        id: "navbar"
      }, [routes(mdl).map(function (r) {
...
var ToolBar = function ToolBar() {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".toolbar", m("nav.frow row-between row-center", [m("nav.frow", [mdl.settings.profile == "desktop" ? mdl.state.user ? m(_index.LockLine, {
        onclick: function onclick() {
          return mdl.state.showAuthModal(true);
        }
      }) : m(".frow", [m(_navLink["default"], {
        mdl: mdl,
        href: "/login",
        link: "Login",
        classList: "".concat(isActiveRoute("/login"), " button")
      ...
      }, m(_index.MenuLine))]), m(_navLink["default"], {
        mdl: mdl,
        href: "/",
        classList: "logo",
        link: m("icon", {
      ...
      }), m("nav.navbar-section.toolbar-section", [m(_navLink["default"], {
        mdl: mdl,
        href: "/cart",
...
;require.register("Layouts/body.js", function(exports, require, module) {
"use strict";
...
var _navMenu = _interopRequireDefault(require("Components/nav-menu.js"));
...
var Body = function Body() {
  return {
    view: function view(_ref) {
      ...
      return m(".body", {
        id: "body"
      }, m(".frow-container", [mdl.settings.profile !== "desktop" && mdl.state.showNavMenu() && m(_navMenu["default"], {
        mdl: mdl
      }), children]));
    }
  };
  ...
  return {
    view: function view(_ref) {
      ...
      var routes = mdl.Routes.filter(function (r) {
        return r.group.includes("other");
      });
      return m("nav", {
        id: "footer"
      }, m(".frow row-around", routes.map(function (r) {
        return m(_navLink["default"], {
          mdl: mdl,
          href: r.route,
          link: r.name,
...
;require.register("Layouts/header.js", function(exports, require, module) {
"use strict";
...
var _mockData = _interopRequireDefault(require("./mock-data"));
...
var validateForm = function validateForm(mdl) {
  return function (data) {
    ...
    (0, _Validations.validateLoginTask)(data.userModel).chain(loginUser(mdl)).fork(onError, onSuccess);
  };
};
...
var Login = function Login() {
  return {
    view: function view(_ref2) {
      var mdl = _ref2.attrs.mdl;
      return m(".frow centered", [m("h1.title", mdl.state.route.name), m("form.frow centered", {
        role: "form",
        id: "Login-form",
        onsubmit: function onsubmit(e) {
          return e.preventDefault();
        }
      }, [m(".form-group", state.isSubmitted && {
        "class": state.errors.email ? "has-error" : "has-success"
      }, [m("label.bold", {
        "for": "reg-email"
      }, "Email"), m("input.form-input", {
        id: "reg-email",
        type: "email",
        placeholder: "Email",
      ...
      }), state.errors.email && m("p.form-input-hint", state.errors.email)]), m(".form-group", state.isSubmitted && {
        "class": state.errors.password ? "has-error" : "has-success"
      }, [m("label.bold", {
        "for": "reg-pass"
      }, "Password"), m("input.form-input", {
        id: "reg-pass",
        type: "password",
      ...
      }), state.errors.password && m("p.form-input-hint", state.errors.password)]), state.httpError && m(".toast toast-error", state.httpError)], m("input", {
        type: "submit",
        form: "login-form",
        onclick: function onclick() {
...
var validateForm = function validateForm(mdl) {
  return function (data) {
    ...
    state.isSubmitted = true;
    (0, _Validations.validateUserRegistrationTask)(data.userModel).chain(registerUser(mdl)).fork(onValidationError, onSuccess);
  };
};
  ...
  return {
    view: function view(_ref2) {
      ...
      return [m(".form-group ", isSubmitted && {
        ...
        "for": "reg-name"
      }, ["Name", m("span.span required", "*")]), m("input.form-input", {
        id: "reg-name",
        type: "text",
        placeholder: "Name",
        onkeyup: function onkeyup(e) {
        ...
        value: data.name
      }), errors.name && m("p.form-input-hint", errors.name)]), m(".form-group", isSubmitted && {
        "class": errors.email ? "has-error" : "has-success"
      }, [m("label.bold", {
        "for": "reg-email"
      }, ["Email", m("span.span required", "*")]), m("input.form-input", {
        id: "reg-email",
        type: "email",
        placeholder: "Email",
        onkeyup: function onkeyup(e) {
        ...
        value: data.email
      }), errors.email && m("p.form-input-hint", errors.email)]), m(".form-group", isSubmitted && {
        "class": errors.confirmEmail ? "has-error" : "has-success"
      }, [m("label.bold", {
        "for": "confirmEmail"
      }, ["Confirm Email", m("span.span required", "*")]), m("input.form-input", {
        id: "confirmEmail",
        type: "email",
        placeholder: "Email",
        onkeyup: function onkeyup(e) {
      ...
      }), errors.confirmEmail && m("p.form-input-hint", errors.confirmEmail)]), m(".form-group", isSubmitted && {
        "class": errors.password ? "has-error" : "has-success"
      }, [m("label.bold", {
        "for": "reg-pass"
      }, ["Password", m("span.span required", "*")]), m("input.form-input", {
        id: "reg-pass",
        type: "password",
        placeholder: "must contain and not contain",
        onkeyup: function onkeyup(e) {
        ...
        value: data.password
      }), errors.password && m("p.form-input-hint", errors.password)]), m(".form-group", isSubmitted && {
        "class": errors.confirmPassword ? "has-error" : "has-success"
      }, [m("label.bold", {
        "for": "pass-confirm"
      }, ["Confirm Password", m("span.span required", "*")]), m("input.form-input", {
        id: "pass-confirm",
        type: "password",
        placeholder: "must contain and not contain",
        onkeyup: function onkeyup(e) {
  ...
  return {
    view: function view(_ref3) {
      ...
      return [m(".frow centered", [m("h1.title", mdl.state.route.name), m("form.frow centered", {
        ...
        "class": mdl.state.isLoading() && "loading"
      }, "Register")])]), state.httpError && m(".toast toast-error", state.httpError)];
    }
  };
};
...
var Blankets = function Blankets() {
  ...
  return {
    ...
    view: function view(_ref2) {
      var mdl = _ref2.attrs.mdl;
      return m(".container", [m("h1.title", mdl.state.route.name), m(_Masonry["default"], {
        data: state.data
      })]);
    }
  };
...
var Blog = function Blog() {
  ...
  return {
    ...
    view: function view(_ref2) {
      ...
      return m(".container", {
        id: "home-page"
      }, [m("h1.title", mdl.state.route.name), m(_Masonry["default"], {
        data: state.data
      })]);
    }
  };
...
var Default = function Default(mdl) {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".empty", m("h1.title", mdl.state.route.name));
    }
  };
};
...
var _toolbarRoutes = _interopRequireDefault(require("./toolbar-routes.js"));

var _authenticatedRoutes = _interopRequireDefault(require("./authenticated-routes.js"));

var _navbarRoutes = _interopRequireDefault(require("./navbar-routes.js"));

var _otherRoutes = _interopRequireDefault(require("./other-routes.js"));

var _ramda = require("ramda");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

var Routes = (0, _ramda.flatten)([_toolbarRoutes["default"], _navbarRoutes["default"], _otherRoutes["default"], _authenticatedRoutes["default"]]);
var _default = Routes;
exports["default"] = _default;
});

;require.register("Routes/navbar-routes.js", function(exports, require, module) {
"use strict";
...
var NavbarRoutes = [{
  ...
  component: function component(mdl) {
    return (0, _mithril["default"])(_index["default"], {
      mdl: mdl
    }, (0, _mithril["default"])(_burpRags["default"], {
      mdl: mdl
    }));
  }
}, {
  ...
  component: function component(mdl) {
    return (0, _mithril["default"])(_index["default"], {
      mdl: mdl
    }, (0, _mithril["default"])(_blankets["default"], {
      mdl: mdl
    }));
  }
}];
var _default = NavbarRoutes;
exports["default"] = _default;
});

;require.register("Routes/other-routes.js", function(exports, require, module) {
"use strict";
...
var _default = OtherRoutes;
exports["default"] = _default;
});

;require.register("Routes/toolbar-routes.js", function(exports, require, module) {
"use strict";
...
var ToolbarRoutes = [{
  ...
  component: function component(mdl) {
    return (0, _mithril["default"])(_index["default"], {
      mdl: mdl
    }, (0, _mithril["default"])(_home["default"], {
      mdl: mdl
    }));
  }
}, {
  ...
  component: function component(mdl) {
    return (0, _mithril["default"])(_index["default"], {
      mdl: mdl
    }, (0, _mithril["default"])(_default2["default"], {
      mdl: mdl
    }));
  }
}, {
  ...
  component: function component(mdl) {
    return (0, _mithril["default"])(_index["default"], {
      mdl: mdl
    }, (0, _mithril["default"])(_loginUser["default"], {
      mdl: mdl
    }));
  }
}, {
  ...
  component: function component(mdl) {
    return (0, _mithril["default"])(_index["default"], {
      mdl: mdl
    }, (0, _mithril["default"])(_registerUser["default"], {
      mdl: mdl
    }));
  }
}];
var _default = ToolbarRoutes;
exports["default"] = _default;
});
...
var BackEnd = {
  API_KEY: "39031BDF-41C2-46FD-BF30-3AB1D24A84C2",
  APP_ID: "EC4C8361-460A-630A-FF70-26AF00905D00",
