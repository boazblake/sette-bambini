...
var Fig = {
  view: function view(_ref) {
    var children = _ref.children,
        id = _ref.attrs.id;
    return m("figure#".concat(id, "-slidy"), children);
  }
};
var Grid = {
  oncreate: function oncreate(_ref2) {
    ...
    return (0, _slider["default"])({
      slidyContainerSelector: dom,
      slidySelector: "#".concat(id, "-slidy")
    });
  },
  view: function view(_ref3) {
    var children = _ref3.children,
        ...
        id = _ref3$attrs.id,
        maxheight = _ref3$attrs.maxheight,
        height = _ref3$attrs.height,
        overflow = _ref3$attrs.overflow;
    return m("#".concat(id), {
      style: {
        overflow: overflow,
        maxHeight: maxheight,
...
var PriceAdjustment = function PriceAdjustment() {
  ...
  return {
    ...
    view: function view(_ref4) {
      ...
      return m("section", [m("h3", "Update Prices"), Prices(mdl), m("button", {
        onclick: function onclick(e) {
...
var Login = function Login() {
  return {
    ...
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".frow centered pt-30", [state.showErrorMsg() && m("code.warning", state.errorMsg()), m("form.frow", {
        role: "form",
        id: "login-form",
...
var imgs = _indexImages.blankets.map(function (srcSet, id) {
  return m("img.slidy-img", {
    id: id,
    srcSet: srcSet
  });
});
...
var Blankets = function Blankets() {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".frow-container frow-center", m(".text-2halfx", m("h2.pb-10", "Wraps")), m(".frow.gutters.mb-30", {
        id: "wraps"
...
var imgs = _indexImages.burpies.map(function (srcSet, id) {
  return m("img.slidy-img", {
    id: id,
    srcSet: srcSet
  });
...
var imgs = _indexImages.collections.map(function (srcSet, id) {
  return m("img.slidy-img", {
    id: id,
    srcSet: srcSet
  });
...
var Collections = function Collections() {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".frow-container frow-center", [m(".frow.gutters.mb-30", {
        id: "collections"
      }, [m(".col-md-1-2", m(_grid["default"], {
        id: "collections",
        height: "400px",
...
function _default(newOptions) {
  ...
  CS.init = function () {
    ...
    if (CS.element.style.animationName !== undefined) CS.hasAnimation = true; // browser supports keyframe animation w/ prefixes
    ...
    if (CS.hasAnimation === false) {
      for (var i = 0; i < CS.domPrefixes.length; i++) {
        if (CS.element.style[CS.domPrefixes[i] + "AnimationName"] !== undefined) {
          ...
          CS.hasAnimation = true; // determines CSS prefix required for CSS animations
    ...
    if (CS.hasAnimation === true) {
      ...
      while (L) {
        ...
        who = images[--L]; // wraps all images in the slider with <figure> tags
        ...
        if (options.captionSource == "alt" || options.captionSource == "data-caption") {
          if (caption !== null) {
            ...
            content.innerHTML = caption; // places captions in each <figure> element, if required
          }
        }
      ...
      if (options.captionSource == "alt" || options.captionSource == "data-caption") {
        ...
        var captionHeight = captions.length && captions[0].offsetHeight * 2 + parseInt(window.getComputedStyle(captions[0]).fontSize, 10);
        ...
        css.innerHTML += " font-size: " + options.captionSize + "; padding: " + options.captionPadding + "; " + CS.keyframeprefix + "transition: .5s; }\n";
      ...
      css.innerHTML += "@" + CS.keyframeprefix + "keyframes " + options.cssAnimationName + " {\n";
      ...
      css.innerHTML += CS.keyframeprefix + "transform: translate3d(0,0,0); " + CS.keyframeprefix + "animation: " + totalTime + "s " + options.cssAnimationName + " infinite; }\n"; // call on the completed keyframe animation sequence
      // place css style tag
...
var collections = ["images/collections/collection1-1200.webp", "images/collections/collection2-1200.webp", "images/collections/collection3-1200.webp", "images/collections/collection4-1200.webp", "images/collections/collection5-1200.webp", "images/collections/collection6-1200.webp", "images/collections/collection7-1200.webp", "images/collections/collection8-1200.webp", "images/collections/collection9-1200.webp", "images/collections/collection10-1200.webp"];
exports.collections = collections;
var blankets = ["images/blankets/blankets1-1200.webp", "images/blankets/blankets2-1200.webp", "images/blankets/blankets3-1200.webp", "images/blankets/blankets4-1200.webp"];
exports.blankets = blankets;
var burpies = ["images/burps/burp1-1200.webp", "images/burps/burp2-1200.webp", "images/burps/burp3-1200.webp", "images/burps/burp4-1200.webp"];
