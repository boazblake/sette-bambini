...
var Invoice = function Invoice(_ref4) {
  ...
  return {
    view: function view(_ref5) {
      ...
      }, m("tr", m("td", m("label", "Shipping Destination"), "".concat(invoice.shippingDestination.address.address_line_1, " ").concat(invoice.shippingDestination.address.admin_area_2, " ").concat(invoice.shippingDestination.address.admin_area_1, " ").concat(invoice.shippingDestination.address.postal_code)), m("td", m("button", "Update Shipping Status"))), m("table", {
        style: {
          width: "100%",
          borderBottom: "1px solid gold"
        }
  ...
  return {
    view: function view(_ref4) {
      ...
      return amount ? m(".frow column-start", [m("h3", "".concat(amount, " ").concat(title, " for $").concat(price)), m(".frow cart-item row-around", m("img", {
        ...
        return m(".", "".concat(sex, " : ").concat(quantity));
      }))]) : null;
    }
  };
};
...
var Cart = function Cart(_ref3) {
  ...
  return {
    ...
    view: function view(_ref5) {
      ...
      }), m(".frow-center", (0, _Utils.getTotal)(mdl, (0, _Utils.toProducts)(mdl.cart)) ? m(_navLink.NavLink, {
        mdl: mdl,
        href: "/checkout",
...
var Gender = function Gender() {
  return {
    view: function view(_ref) {
      ...
      return quantity ? m(".", [, m("h4", "".concat(sex, " : ").concat(quantity))]) : null;
    }
  };
};
...
var Product = function Product() {
  return {
    view: function view(_ref2) {
      ...
      var amount = (0, _helpers.getQuantity)(genders);
      var price = (0, _helpers.getPrice)(mdl, title, genders);
      return amount ? m(".frow column-start mt-10", [m("span.underline", m("h3.mb-10", "".concat(amount, " ").concat(title, " for $").concat(price))), m("table", {
        "table-layout": "fixed",
        style: {
          width: "100%"
        }
        ...
        style: {
          width: mdl.settings.screenSize == "desktop" ? "25%" : "50%"
        }
      }, m("img", {
        style: {
          width: mdl.settings.screenSize == "desktop" ? "100%" : "50%"
        },
        srcSet: _indexImages.productImages[title][0]
      })), m("td", m("table", {
        "table-layout": "fixed",
      ...
      }, genders.map(function (_ref3) {
        var _ref4 = _slicedToArray(_ref3, 2),
            sex = _ref4[0],
            quantity = _ref4[1];

        return m("tr", m("th", m("h4", {
          style: {}
        }, sex)), m("td", m("h4", {
          style: {}
        }, quantity)));
