...
exports.loginUserTask = void 0;

var loginUserTask = function loginUserTask(mdl) {
  return function (_ref) {
    var email = _ref.email,
        password = _ref.password;
    return mdl.http.backEnd.postTask(mdl)("users/login?loadRelations=Account")({
      login: email,
      password: password
    });
  };
...
var validateForm = function validateForm(mdl) {
  return function (data) {
    ...
    (0, _Validations.validateLoginTask)(data.userModel).chain((0, _fns.loginUserTask)(mdl)).fork(onError, onSuccess);
  };
};
...
var validateForm = function validateForm(mdl) {
  return function (data) {
    ...
    state.isSubmitted = true;
    (0, _Validations.validateUserRegistrationTask)(data.userModel).chain(registerUserTask(mdl)).fork(onError, onSuccess(mdl));
  };
};
...
var registerUserTask = function registerUserTask(mdl) {
  return function (_ref) {
    ...
    return mdl.http.backEnd.postTask(mdl)("users/register")({
      ...
      return mdl.http.backEnd.postTask(mdl)("data/Users/".concat(mdl.user.objectId, "/account%3AAccount%3A1"))([accnt.objectId]);
    });
  };
};
...
exports.getLocalStorageTask = void 0;
...
if (localStorage.getItem("sb-user")) {
  ...
  _Models["default"].state.isAuth(true); //fetch cart from db? do i really??
