  ...
  return {
    view: function view(_ref) {
      var _ref$attrs = _ref.attrs,
          ...
          classList = _ref$attrs$classList === void 0 ? "nav-link" : _ref$attrs$classList,
  ...
  return {
    view: function view(_ref2) {
      ...
      return m(".navMenu.animated", {
        ...
        link: "Your Account",
        classList: "".concat(isActiveRoute("/account/".concat(mdl.user.name)), " button")
      }) : m(".frow", [m(NavItem, {
        mdl: mdl,
        href: "/login",
        link: "Login",
        classList: "".concat(isActiveRoute("/login"), " button para")
      }), m(NavItem, {
        mdl: mdl,
        href: "/register",
        link: "Register",
        classList: "".concat(isActiveRoute("/register"), " button para")
...
;require.register("Components/sub-nav.js", function(exports, require, module) {
"use strict";
...
var SubNavBar = function SubNavBar() {
  ...
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".sub-navbar", m("nav.frow row-around hidden-xs", {
        id: "sub-navbar"
      }, [routes(mdl).map(function (r) {
        return m(_navLink["default"], {
          mdl: mdl,
...
var ToolBar = function ToolBar() {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".toolbar", m(".frow row-between row-center", [m(".frow", [m(".navMenuButton visible-xs", {
        onclick: function onclick() {
        ...
        href: "/account/".concat(mdl.user.name),
        link: "Your Account",
        classList: "".concat(isActiveRoute("/account/".concat(mdl.user.name)), " button hidden-xs")
...
var _subNav = _interopRequireDefault(require("Components/sub-nav.js"));
  ...
  return {
    view: function view(_ref) {
      ...
      return m(".layout", {
        ...
        mdl: mdl
      }), mdl.state.isLoading() ? m(_LogoLoader["default"]) : m(_body["default"], {
        mdl: mdl,
        children: children
      }), m(_footer["default"], {
        mdl: mdl
...
var validateForm = function validateForm(mdl) {
  return function (data) {
    ...
    var onSuccess = function onSuccess(data) {
      ...
      mdl.user = data;
      m.route.set("/account/".concat(mdl.user.name));
    };
...
var Login = function Login() {
  return {
    ...
    view: function view(_ref2) {
      ...
      }), state.errors.email && m("p.form-input-hint", state.errors.email), m("input.form-input", {
      ...
      }), state.errors.password && m("p.form-input-hint", state.errors.password)]), state.httpError && m(".toast toast-error", state.httpError)], m("a.button.auth-btn", {
        // type: "submit",
        form: "login-form",
        onclick: function onclick() {
...
var validateForm = function validateForm(mdl) {
  return function (data) {
    ...
    state.isSubmitted = true;
    (0, _Validations.validateUserRegistrationTask)(data.userModel).chain(registerUser(mdl)).fork(onError, onSuccess);
  };
};
  ...
  return {
    view: function view(_ref2) {
      ...
      return [m("input.form-input", {
        ...
        value: data.name
      }), errors.name && m("p.form-input-hint", errors.name), m("input.form-input", {
        ...
        value: data.email
      }), errors.email && m("p.form-input-hint", errors.email), m("input.form-input", {
        id: "confirmEmail",
      ...
      }), errors.confirmEmail && m("p.form-input-hint", errors.confirmEmail), m("input.form-input", {
        ...
        value: data.password
      }), errors.password && m("p.form-input-hint", errors.password), m("input.form-input", {
...
var Blankets = function Blankets() {
  ...
  return {
    ...
    view: function view(_ref2) {
      var mdl = _ref2.attrs.mdl;
      return m(".frow-container frow-center", [m(_Masonry["default"], {
        data: state.data
      })]);
    }
  };
